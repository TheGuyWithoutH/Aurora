...
let CustomAgent = class CustomAgent extends BaseScriptComponent {
    ...
    // Method to send transcribed text to your API server
    async callRpcServer(transcribedText) {
        ...
        try {
            print("Sending to API server: " + transcribedText);
            // Create the request
    ...
    __initialize() {
        ...
        this.isTranscribing = false;
        this.apiServerUrl = "https://disklike-crysta-nonalkaloidal.ngrok-free.dev/api/agent/process";
